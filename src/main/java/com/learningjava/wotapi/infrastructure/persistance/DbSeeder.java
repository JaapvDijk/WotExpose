...
public class DbSeeder {
    ...
    private void addMissingVehicles() {
        ...
        var missingVehicles = new ArrayList<>(List.of(
            new Vehicle(LocalDate.now(), new VehicleKey(17153, RegionType.EU), "Obj. 430B", "Object 430B", "ussr", false, "", "mediumTank", 10, true, null),
            new Vehicle(LocalDate.now(), new VehicleKey(16913, RegionType.EU), "Waffenträger auf E 100", "Waffenträger auf E 100", "germany", false, "", "AT-SPG", 10, true, null),
            new Vehicle(LocalDate.now(), new VehicleKey(14337, RegionType.EU), "Object 263B", "Object 263B", "ussr", false, "", "AT-SPG", 10, true, null),
            new Vehicle(LocalDate.now(), new VehicleKey(12033, RegionType.EU), "SU-122-5", "SU-122-5", "ussr", false, "", "AT-SPG", 9, true, null),
            new Vehicle(LocalDate.now(), new VehicleKey(56833, RegionType.EU), "T-44-122", "T-44-122", "ussr", true, "", "AT-SPG", 7, true, null)
        ));
